...
<div style={{ width: '50px' }} className='flex justify-start'>
      <ArrowRightAltIcon
        ...
        style={{ width: isHoverWestKaftans ? '32px' : '44px', transition: 'width 0.3s ease', transform: 'scaleX(-1)' }}
      />
      </div>
      <a style={{ cursor: 'pointer' }}>KAFTANS</a>
                                        ...
                                        {openItemIndexKaftans === index && (
                                            ...
                                            >
                                                <div className='flex justify-between items-start  mb-4 mt-1'>
                                                    <CloseIcon style={{ color: '#777777' }} className='cursor-pointer p-1' onClick={() => { toggleOptionsKaftans(index) }} />
