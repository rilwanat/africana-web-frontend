        ...
        <Fragment>
            <div className="widget woocommerce widget_product_tag_cloud">
                ...
                <div className="tagcloud flex" >
                    <a  className="tag-cloud-link" style={{marginTop: '2px'}}>Women</a>
                    <a  className="tag-cloud-link" style={{marginTop: '2px'}}>Brown</a>
                    <a  className="tag-cloud-link" style={{marginTop: '2px'}}>Men</a>
                </div>
            </div>
        </Fragment>
    );
